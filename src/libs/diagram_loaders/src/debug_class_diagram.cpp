...
diagram_model::ClassDiagram generate_debug_class_diagram() {
            ...
            std::initializer_list<diagram_model::ChildObject> children = {})
    {
        ...
        cl.parent_class_id = parent_class_id ? parent_class_id : "";
        cl.x = x;
        cl.y = y;
    ...
    add_class("GameObject", "GameObject", nullptr, 60, 40,
    ...
    add_class("Player", "Player", "Character", 60, 460,
